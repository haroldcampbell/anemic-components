...
export * from "../../lib/ancui-intents-arcs"
...
describe("Arc Intents", () => {
  ...
  it("$arcRadius() should set the radius of each arc to the same value", () => {
    localIntents.$arcRadius(10).action(visual);
  ...
  it("$arcRadiusOffset() should increment radius of each arc", () => {
    ...
    localIntents.$arcRadiusOffset(5).action(visual);
  ...
  it("$arcSpanUnit() should set the relative span/length of each arc", () => {
    localIntents.$arcSpanUnit(60).action(visual);
...
}); // end describe Arc Intents

describe("Arc Intents $arcSpanOffset", () => {
  let spanOffset = 50;
  let visual = null;
  let localIntents;
  let data = $data([8, 5, 10]);
  ...
  it("should be added to each arc", () => {
    localIntents.$arcSpanOffset(50).action(visual);
  ...
  it("should update visual.$startAngle()", () => {
    ...
    localIntents.$arcSpanOffset(spanOffset).action(visual);
...
describe("Arc Intents $arcRotateBy", () => {
  let spanOffset = 50;
  ...
  it("should increment the visual.$startAngle()", () => {
    ...
    localIntents.$arcRotateBy(rotationInDegrees).action(visual);
...
describe("$arcRenderFn", () => {
  ...
  it("should execute callback", () => {
    ...
    localIntents.$arcRenderFn(local, callback).action(visual);
  ...
  it("should call visual.__renderPath() after executing callback", () => {
    ...
    localIntents.$arcRenderFn({}, callback).action(visual);
  ...
  it("$arcIntentFn", () => {
    ...
    localIntents.$arcIntentFn({}, callback).action(visual);
