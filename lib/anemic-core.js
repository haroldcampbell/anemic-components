...
/*
  ...
  //import * as utils from "anemic-utils"
*/
...
function $node(tag, parentElm) {
  ...
  /* Positions the node at the bottom of the render tree. */
  // node.$toBottom = function(){
  //   $log(node.parentElement)
  //   let children = node.parentElement.childNodes();
  //   let firstChild = children[0];
  //
  //   node.parentElement.insertBefore(node, firstChild);
  // }
