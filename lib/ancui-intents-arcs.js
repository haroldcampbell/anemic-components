...
*/
__intents.internal.$arcIntentFn = function(data, callback) {
  this.items.push({
    name: "arcIntentFn",
    data,
    action(visuals) {
...
/**
  ...
  @return {Object}
*/
__intents.internal.$arcRenderFn = function(data, callback) {
  this.items.push({
    name: "arcRenderFn",
    data,
    action(visuals) {
...
/**
  ...
  @return {Object}
*/
__intents.internal.$arcRotateBy = function(data) {
  this.items.push({
    name: "arcRotateBy",
    data,
    action(visuals) {
...
*/
__intents.internal.$arcSpanOffset = function(data) {
  this.items.push({
    name: "arcSpanOffset",
    data,
    action(visuals) {
...
/**
  ...
  @return {Object}
*/
__intents.internal.$arcSpanUnit = function(data) {
  this.items.push({
    name: "arcSpanUnit",
    data,
    action(visuals) {
...
*/
__intents.internal.$arcRadiusOffset = function(data) {
  this.items.push({
...
*/
__intents.internal.$arcRadius = function(data) {
  this.items.push({
    name: "radius",
    data,
    action(visuals) {
